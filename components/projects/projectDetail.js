      ...
      <Row>
        <Col md="6">
          <Card className="border-0">
            <h5 className="card-title text-left project-detail-title">
              Problem
            </h5>
            <div className="text-left mt-3 img-holder">
              <img
        ...
        <Row>
          <Col md="6">
            <div className="card-body" style={{ paddingLeft: '0' }}>
              <p className="card-text text-left">{project.problem}</p>
            </div>
          </Col>
          <Col md="6">
            <div className="card-body" style={{ paddingLeft: '0' }}>
              <p className="card-text text-left">{project.solution}</p>
            </div>
          </Col>
        </Row>
      </Row>
